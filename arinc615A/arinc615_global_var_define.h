...
#define A615_OPT_ERROR23				-223			/*协议层错误:没有获取到状态文件*/
...
#define STATUS_TIMEOUT				1000				//等待状态文件的sleep时间，单位ms
#define MAX_STATUS_TIMEOUT			10					//最长等待时间10s


#define MAX_TRANS_FILE_NUMBER				50			//最大支持传输的文件数量

#define OPERATION_FINISH_CODE				0x0003		//传输完成的标志
#define A_HUNDRED_PERCENT					100			//百分之百

#define MIN_NUMBER_ERROR					(0.000001)		//判断两个浮点数是否相等的最小误差
...
#define HOST_OPERATION_BIND_PORT 59                  //流程操作监听端口
#define HOST_OPERATION_SEND_PORT 59                //流程操作发送端口

#define HOST_STATUS_BIND_PORT    55555               //状态文件监听端口
#define HOST_STATUS_SEND_PORT    1022                //状态文件发送端口
